  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        <a
          href="#hero"
          className="font-display text-[1.2rem] tracking-widest text-white"
        >
...
function Hero() {
  return (
    <section
      id="hero"
      className="relative h-screen min-h-[660px] flex items-center overflow-hidden bg-[#030608]"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pt-24">
        <div style={{ animation: "fade-up 0.65s ease-out 0.35s both" }}>
          <div className="flex items-center gap-3 mb-8 text-[#00b4d8]">
            ...
            <span className="text-[9px] tracking-[0.45em] uppercase opacity-70">
              Lahore, Pakistan
            </span>
          </div>
        </div>
      ...
      >
        <span className="text-[8px] tracking-[0.45em] uppercase text-white/20">
          Scroll
        </span>
...
const WORKS: Work[] = [
  {
    ...
    videoUrl:
      "https://res.cloudinary.com/qihhar33/video/upload/v1789484902/food.mp4",
  ...
  },
  {
    ...
    videoUrl:
      "https://res.cloudinary.com/qihhar33/video/upload/v1789484465/echos_of_tomoorow.mp4",
    label: "Short Film",
  ...
  },
  {
    ...
    videoUrl:
      "https://res.cloudinary.com/qihhar33/video/upload/v1789484897/gym.mp4",
    label: "Gym Portrait",
  ...
  },
  {
    ...
    videoUrl:
      "https://res.cloudinary.com/qihhar33/video/upload/v1789484902/coffee_2.mp4",
    label: "Restaurant",
    title: "BOLD BREW. CINEMATIC POUR.",
    size: "normal",
    accent: "amber",
  },
  {
    ...
    videoUrl:
      "https://res.cloudinary.com/qihhar33/video/upload/v1789484899/product_compain.mp4",
    label: "Commercial",
  ...
  },
  {
    ...
    videoUrl:
      "https://res.cloudinary.com/qihhar33/video/upload/v1789486293/documentry.mp4",
    label: "Documentary",
    title: "ANDROON LAHORE",
    size: "wide",
    accent: "cyan",
  },
]
        ...
        >
          <div className="flex items-center gap-3 mt-1">
            ...
            <span className="text-[9px] tracking-[0.35em] uppercase text-white/60">
              {work.label === "Gym Portrait" ? "Gym Energy" : "Watch Video"}
            </span>
          </div>
        </div>
      </div>
      ...
      >
        <div className="mb-14 flex items-end justify-between flex-wrap gap-6">
          ...
          <p className="text-white/38 text-sm max-w-[280px] leading-relaxed">
            From sizzling food commercials to moody cinematic short films —
...
function About() {
  const { ref, visible } = useFadeUp()
  const tools = ["DaVinci Resolve", "After Effects", "Lightroom"]
      ...
      >
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-5 right-6 md:-right-5 bg-[#00b4d8] text-black px-6 py-4">
            <div className="font-display text-[2.2rem] leading-none">3+</div>
            <div className="text-[9px] tracking-[0.25em] uppercase font-bold mt-0.5">
              Years Active
            </div>
          </div>
        </div>
        ...
        <div className="pt-6 md:pt-0">
          ...
          <p className="text-white/52 text-[15px] leading-[1.8] mb-4">
            Based in Lahore, Pakistan, I am a filmmaker, cinematographer, and
            editor with a passion for capturing authentic moments and crafting
            compelling visual narratives. From sizzling food commercials to
            moody cinematic short films, every project pushes the limits of
            visual storytelling.
          </p>
          <p className="text-white/52 text-[15px] leading-[1.8] mb-9">
            My work spans commercial production, documentary, and narrative
            filmmaking — always with a commitment to technical excellence and
            distinctive artistic vision.
          </p>

          <div className="mb-6">
            <div className="text-white/28 text-[9px] tracking-[0.28em] uppercase mb-3">
              Software
            </div>
            <div className="flex flex-wrap gap-2">
              {tools.map((t) => (
                <span
                  key={t}
                  className="px-3 py-2 border border-white/10 text-white/55 text-[11px] tracking-wide transition-all duration-300 hover:-translate-y-0.5 hover:border-[#00b4d8]/60 hover:text-[#00b4d8] hover:bg-[#00b4d8]/5 hover:shadow-[0_0_20px_rgba(0,180,216,0.12)]"
                >
                  {t}
                </span>
              ))}
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {gear.map((g) => (
                <span
                  key={g}
                  className="px-3 py-2 border border-[#00b4d8]/22 bg-[#00b4d8]/[0.05] text-[#00b4d8]/75 text-[11px] tracking-wide transition-all duration-300 hover:-translate-y-0.5 hover:border-[#00b4d8]/60 hover:bg-[#00b4d8]/10 hover:text-[#8ee7ff] hover:shadow-[0_0_22px_rgba(0,180,216,0.18)]"
                >
                  {g}
                </span>
              ))}
          ...
          {SERVICES.map((s) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-white font-semibold mb-3 tracking-wide text-[15px]">
                  {s.title}
                </h3>
        ...
        >
          ...
          >
            <img
              ...
              style={{
                filter:
                  "saturate(1.55) contrast(1.22) brightness(0.88) hue-rotate(-4deg)",
              }}
              draggable={false}
            />
          </div>
...
function StatItem({
  ...
  return (
    <div ref={ref} className="text-center py-12 px-6">
      ...
      <div className="text-white/32 text-[9px] tracking-[0.38em] uppercase mt-4">
        {label}
      </div>
    </div>
  )
      ...
      >
        ...
        <div>
          ...
          <p className="text-white/42 text-sm leading-relaxed mb-10 max-w-[320px]">
            Available for commercial projects, short films, food videography,
            and creative collaborations. Based in Lahore — working worldwide.
          </p>
